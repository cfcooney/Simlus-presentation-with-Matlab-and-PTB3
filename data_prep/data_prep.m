...
[jump, fs] = audioread([audio_folder 'jump' '.wav'],[3200 7000]);
...
[kiss, fs] = audioread([audio_folder 'kiss.ogg'],[6000 22500]);
audiowrite([folder 'kiss.ogg'], kiss, fs);

[squeeze, fs] = audioread([folder 'squeeze.ogg'],[15000 75000]);
audiowrite([folder 'squeeze.ogg'], kiss, fs);

[smile, fs] = audioread([folder 'smile.ogg'],[6000 28000]);
audiowrite([folder 'squeeze.ogg'], smile, fs);
